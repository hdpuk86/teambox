...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post team_members_url, params: { team_member: { first_name: @team_member.first_name, last_name: @team_member.last_name } }
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { first_name: @team_member.first_name, last_name: @team_member.last_name } }
